      ...
      <div className='flex  justify-center h-[50vh] mt-10'>
        <ul className=' grid w-full grid-cols-3 gap-x-5 px-8'>
          <li className=''>
            ...
            <div className='absolute bg-white shadow-lg left-0 p-6 border mt-2 border-indigo-300 rounded-lg w-[98vw] mx-auto h-[43vh]  opacity-0 invisible peer-checked:opacity-100 peer-checked:visible '>
              {card.description}
            </div>
          </li>
          ...
          <li className=''>
            ...
            <div className='absolute bg-white shadow-lg left-0 p-6 border mt-2 border-indigo-300 rounded-lg w-[98vw] h-[43vh] opacity-0 invisible peer-checked:opacity-100 peer-checked:visible  text-black '>
